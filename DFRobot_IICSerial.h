...
protected:
  ...
  */
  ...
  /*
   SIER description of WK2132 sub UART interrupt enable register:
     * --------------------------------------------------------------------------------------------
     * |    b7    |   b6   |   b5   |   b4   |      b3     |     b2     |     b1     |     b0     |
     * --------------------------------------------------------------------------------------------
  ...
  */
  ...
  /*
   FCR description of WK2132 sub UART FIFO control register:
     * -------------------------------------------------------------------------
     * |   b7   |   b6   |   b5   |   b4   |   b3   |   b2   |   b1   |   b0   |
     * -------------------------------------------------------------------------
  ...
  */
  ...
  /*
   SCR description of WK2132 sub UART control register: 
     * -------------------------------------------------------------------------
     * |   b7   |   b6   |   b5   |   b4   |   b3   |   b2   |   b1   |   b0   |
     * -------------------------------------------------------------------------
  ...
  */
  typedef struct{
      uint8_t format: 4;/*!< Sub UART data format: 
                           PAEN sub UART check enable bit, 1-with parity bit(9-bits data), 0-no parity bit (8-bits data) 
                           PAM sub UART check mode selection bit, take effect when PAEN bit is 1, 00-0 parity(default), 01-Odd parity
                           10-Even parity, 11-1 parity, STPL sub UART stop bit length, 0-1bit, 1-2bits, etc.*/                           
...
protected:
   ...
   * @param subUartChannel Sub UART channel: SUBUART_CHANNEL_1 or SUBUART_CHANNEL_2
   * @type Global register type, all enumeration values in eGlobalRegType_t
   */
